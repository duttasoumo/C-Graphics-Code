/*circle_c.c: Write a program to connect the centres of  two circles*/
#include<stdio.h>
#include<graphics.h>
int c,bgcolor;
...
clrscr();
printf("\nEnter x co-ordinate of centre of circle 1:");
scanf("%d",&xc1);
printf("\nEnter y co-ordinate of centre of circle 1:");
scanf("%d",&yc1);
printf("\nEnter x co-ordinate of centre of circle 2:");
scanf("%d",&xc2);
printf("\nEnter y co-ordinate of centre of circle 2:");
scanf("%d",&yc2);
